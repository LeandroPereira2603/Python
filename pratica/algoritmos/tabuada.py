...
#O algoritmo calcula a multiplicação e mostra o resultado da tabuada completa , sendo alterado pelo úsuario o inicio e fim do conjunto , se o usuario colocar o número de forma decrescente o sistema informa inválido .
